...
local colors = {
    dark = {
        ...
        blue       = '#368aeb',  -- blue color
        magenta    = '#eb6eb7',  -- magenta color
        cyan       = '#3fc5b7',  -- cyan color
        orange     = '#e67f43',  -- orange color
        violet     = '#a580e2',  -- violet color
        br_red     = '#ff5e56',  -- bright red
        br_green   = '#83c746',  -- bright green
        br_yellow  = '#efc541',  -- bright yellow
        br_blue    = '#4f9cfe',  -- bright blue
        br_magenta = '#ff81ca',  -- bright magenta
        br_cyan    = '#56d8c9',  -- bright cyan
        br_orange  = '#fa9153',  -- bright orange
        br_violet  = '#b891f5',  -- bright violet
    },
    light = {
        bg_0       = '#ffffff',  -- lighter background
        bg_1       = '#ebebeb',  -- slightly darker background
        bg_2       = '#cdcdcd',  -- even darker background
        dim_0      = '#878787',  -- dimmed text color
        fg_0       = '#474747',  -- primary foreground color
        fg_1       = '#282828',  -- secondary foreground color
        dim_1      = '#878787',  -- yellowish dim_0 for things like autocomplete previews
        bg_15      = '#d7d7d7',  -- subtle background for embedded, selectable blocks
        red        = '#d6000c',  -- red color
        green      = '#1d9700',  -- green color
        yellow     = '#c49700',  -- yellow color
        blue       = '#0064e4',  -- blue color
        magenta    = '#dd0f9d',  -- magenta color
        cyan       = '#00ad9c',  -- cyan color
        orange     = '#d04a00',  -- orange color
        violet     = '#7f51d6',  -- violet color
        br_red     = '#bf0000',  -- bright red
        br_green   = '#008400',  -- bright green
        br_yellow  = '#af8500',  -- bright yellow
        br_blue    = '#0054cf',  -- bright blue
        br_magenta = '#c7008b',  -- bright magenta
        br_cyan    = '#009a8a',  -- bright cyan
        br_orange  = '#ba3700',  -- bright orange
        br_violet  = '#6b40c3',  -- bright violet
        deep_dark  = '#181818',  -- deep dark color
    }
}
...
local highlights = function(colors)
    ...
    hi['Include']                      = 'PreProc'
    hi['Macro']                        = 'Include'
    hi['Type']                         = { fg = colors.green, bg = none }
    hi['Typedef']                      = 'Type'
